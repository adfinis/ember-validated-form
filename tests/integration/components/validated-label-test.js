...
module("Integration | Component | validated label", function (hooks) {
  ...
  testDefault("it renders custom label component", async function (assert) {
  ...
  testDefault(
    "it passes original variables to custom component",
...
/>`);
  ...
  testDefault(
    "it passes custom variables to custom component",
    async function (assert) {
      class CustomLabel extends Component {}
      setComponentTemplate(
