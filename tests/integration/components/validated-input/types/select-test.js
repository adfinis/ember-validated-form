...
module(
  ...
  function (hooks) {
    ...
    testDefault(
      "it supports plain (non-object) options",
...
/>`,
    ...
    testDefault(
      "it works with solitary optionTargetPath property",
      async function (assert) {
        assert.expect(2);
        this.set("options", [
...
/>`,
    ...
    testDefault(
      "it renders option groups via groupLabelPath",
      async function (assert) {
        this.set("options", [
...
/>`,
    ...
    testDefault(
      "it renders option groups pre grouped options",
      async function (assert) {
        this.set("options", [
          {
            groupName: "one",
...
/>`,
    ...
    testDefault("prompt is present and disabled", async function (assert) {
      this.set("options", [
        { key: 1, label: 1 },
        { key: 2, label: 2 },
      ]);
...
/>`,
    ...
    testDefault("prompt is selectable", async function (assert) {
      this.set("options", [
        { key: 1, label: 1 },
        { key: 2, label: 2 },
      ]);
...
/>`,
    ...
    testDefault("multiselect is working", async function (assert) {
      assert.expect(4);
      this.set("options", [
        { id: 1, label: "label 1" },
        { id: 2, label: "label 2" },
...
/>`,
    ...
    testDefault(
      "multiselect is working with plain options",
      async function (assert) {
        assert.expect(4);
...
/>`,
    ...
    testDefault(
      "multiselect works with pre grouped options",
      async function (assert) {
        assert.expect(1);
        this.set("update", (values) => {
...
/>`,
    ...
    testDefault(
      "multiselect works with pre grouped options and optionsTargetPath",
      async function (assert) {
        assert.expect(1);
        this.set("update", (values) => {
          assert.deepEqual(
...
/>`,
    ...
    testDefault(
      "prompt is selectable in compination with optionTargetPath, optionValuePath and optionLabelPath",
      async function (assert) {
        assert.expect(3);
