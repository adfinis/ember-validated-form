...
return q(o)?Promise.resolve(o).then(()=>n.slice(r)):n.slice(r)}(t,e)}const Fe=new WeakMap,He=new WeakMap
...
return e.register("-top-level-view:main",{create:()=>s}),nt(ze).then(()=>((0,h.run)(s,"appendTo",Ve()),Pe()))}).then(()=>(Object.defineProperty(t,"element",{configurable:!0,enumerable:!0,value:!1!==L.EmberENV._APPLICATION_TEMPLATE_WRAPPER?Ve().querySelector(".ember-view"):Ve(),writable:!1}),t))}et=(0,n(814).A)(n(2015)).renderSettled
var st=et
...
y().testing=!0
try{e(t)}catch(e){if(e===t)return lt}finally{y().testing=n}return ut}var ct=n(829)
function dt(e){if("string"==typeof e)return Ve().querySelector(e)
if(C(e)||x(e))return e
...
function Lt(e){return e.activeElement||e.body}function Wt({backwards:e=!1,unRestrainTabIndex:t=!1}={}){return Promise.resolve().then(()=>function(e,t){const n=Ve()
let r,o
...
o&&(t.indexOf(o.value)>-1?o.selected=!0:n||(o.selected=!1))}return Tt(e,"input").then(()=>Tt(e,"change")).then(Pe)}).then(()=>J("select","end",e,t,n))}function Zt(e){if("string"==typeof e)return Ve().querySelectorAll(e)
{const t=(0,ct.lookupDescriptorData)(e)
